...
static NSString * const ID = @"selfordcell";
@interface MCOOrderSub1VC ()
...
//    NSDictionary *dict =@{@"user_phone":[defaults objectForKey:@"user_phone"],@"queryKind":@"0"};
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    MCOSelfOrderCell *cell = [tableView dequeueReusableCellWithIdentifier:ID forIndexPath:indexPath];
...
- (void)loadNewTopics
{
    ...
    mgr.responseSerializer = [AFHTTPResponseSerializer serializer];
    NSUserDefaults *defaults = [NSUserDefaults standardUserDefaults];
    NSDictionary *dict =@{@"user_phone":[defaults objectForKey:@"user_phone"],@"que":@"0"};
    [mgr POST:@"http://106.14.145.208/ShopMall/BackUserOrders" parameters:dict progress:^(NSProgress * _Nonnull uploadProgress) {
...
- (void)loadMoreTopics
{
    ...
    NSDictionary *dict =@{@"user_phone":[defaults objectForKey:@"user_phone"],@"que":@"0",@"lastime":lastorder.ord_time};
    [mgr POST:@"http://106.14.145.208/ShopMall/BackUserOrders" parameters:dict progress:^(NSProgress * _Nonnull uploadProgress) {
