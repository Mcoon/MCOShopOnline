...
@interface MCOGoodPickerVC () <TZImagePickerControllerDelegate>
...
@implementation MCOGoodPickerVC
...
-(void)complete
{
    ...
    else
    {
        ...
        MCOUploadGoodStep5VC *vc = [[MCOUploadGoodStep5VC alloc] init];
        vc.good = self.good;
        vc.images = self.photoArr;
...
////    NSDictionary *dict = @{@"desc":self.good};
