...
#import "MCOManOrderSub3VC.h"
@interface MCOShopManOrderView ()<UIScrollViewDelegate>
...
@implementation MCOShopManOrderView
...
{
    [self addChildViewController:[[MCOManOrderSub1VC alloc] init]];
    [self addChildViewController:[[MCOManOrderSub2VC alloc] init]];
    [self addChildViewController:[[MCOManOrderSub3VC alloc] init]];
...
- (void)setupNavBar
{
    self.navigationItem.title = @"店铺订单";
}
