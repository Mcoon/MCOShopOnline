...
- (void)viewDidLoad {
    ...
    //添加输入框
    self.keyView = [[DKSKeyboardView alloc] initWithFrame:CGRectMake(0, K_Height - StatusNav_Height+18, K_Width, 48)];
    //设置代理方法
...
- (UITableView *)tableView {
    if (!_tableView) {
        _tableView = [[UITableView alloc] initWithFrame:CGRectMake(0, 0, K_Width, K_Height - StatusNav_Height+18) style:UITableViewStylePlain];
